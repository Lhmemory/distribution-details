...
export function Drawer({
  ...
  return (
    <div className="fixed inset-0 z-50 flex justify-end bg-surface-dim/45 backdrop-blur-[1px]">
      ...
      <div className="flex h-full w-full max-w-xl flex-col bg-surface-high p-4 shadow-ambient sm:p-6">
        ...
        {footer ? <div className="mt-4 border-t border-line pt-4 sm:mt-6">{footer}</div> : null}
      </div>
    </div>
  );
}
